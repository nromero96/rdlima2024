window.addEventListener("load", function(){
        ...
        settings: {
            layout: {
                ...
                logo: {
                    ...
                    lightLogo: '../../assets/img/logo2.png'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../assets/img/logo.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../assets/img/logo2.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
